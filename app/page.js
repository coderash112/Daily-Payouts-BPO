...
const services = [
  { 
    icon: Car, 
    title: 'Auto Parts Inhouse', 
    description: 'Expert automotive parts support with in-house specialists',
    profit: '$2000',
    process: [
      { icon: Phone, label: 'Customer Calls' },
      { icon: Headphones, label: 'Agent Responds' },
      { icon: Car, label: 'Parts Booking' },
      { icon: CheckCircle, label: 'Follow-up' }
    ]
  },
  { 
    icon: Headphones, 
    title: 'Printer Support Inhouse', 
    description: 'Dedicated technical support for all printer-related queries',
    profit: '$1000',
    process: [
      { icon: Phone, label: 'Customer Calls' },
      { icon: Headphones, label: 'Agent Assists' },
  ...
  { 
    icon: MessageSquare, 
    title: 'Chat Support - USA/Domestic', 
    description: '24/7 domestic chat support services for US customers',
    profit: '$1000',
    process: [
      { icon: MessageSquare, label: 'Customer Chats' },
      { icon: Headphones, label: 'Agent Responds' },
      { icon: CheckCircle, label: 'Query Solved' },
      { icon: CheckCircle, label: 'Follow-up' }
    ]
  },
  { 
    icon: Plane, 
    title: 'Flight Booking Inhouse', 
    description: 'Inbound flight booking services with trained professionals',
    profit: '$2000',
    process: [
      { icon: Phone, label: 'Customer Calls' },
      { icon: Headphones, label: 'Agent Responds' },
      { icon: Plane, label: 'Flight Booked' },
      { icon: CheckCircle, label: 'Follow-up' }
    ]
  },
  { 
    icon: Ship, 
    title: 'Cruise Booking Inhouse', 
    description: 'Specialized cruise booking and customer support',
    profit: '$2000',
    process: [
      { icon: Phone, label: 'Customer Calls' },
      { icon: Headphones, label: 'Agent Responds' },
      { icon: Ship, label: 'Cruise Booked' },
      { icon: CheckCircle, label: 'Follow-up' }
    ]
  },
  { 
    ...
    description: 'US-focused car rental booking and support services',
    profit: '$1000',
    process: [
      { icon: Phone, label: 'Customer Calls' },
      { icon: Headphones, label: 'Agent Responds' },
      { icon: Car, label: 'Rental Booked' },
      { icon: CheckCircle, label: 'Follow-up' }
    ]
  },
  { 
    icon: Phone, 
    title: 'Voice Process - Domestic Inbound', 
    description: 'Professional inbound voice support for domestic clients',
    profit: '$2000',
    process: [
      { icon: Phone, label: 'Customer Calls' },
      { icon: Headphones, label: 'Agent Responds' },
      { icon: CheckCircle, label: 'Service Done' },
      { icon: CheckCircle, label: 'Follow-up' }
    ]
  },
  { 
    icon: Shield, 
    title: 'Vehicle Insurance Inbound', 
    description: 'Comprehensive vehicle insurance support and policy assistance',
    profit: '$1000',
    process: [
      { icon: Phone, label: 'Customer Calls' },
      { icon: Headphones, label: 'Agent Responds' },
  ...
  { 
    icon: Building2, 
    title: 'Company Incorporation + Merchant Services', 
    description: 'Complete business setup and payment processing solutions',
    profit: '$1000',
    process: [
      { icon: Phone, label: 'Customer Calls' },
      { icon: Headphones, label: 'Agent Responds' },
      { icon: Building2, label: 'Setup Complete' },
      { icon: CheckCircle, label: 'Follow-up' }
    ]
  },
  { 
    icon: Hash, 
    title: 'TFN Services', 
    description: 'Toll-free number services and management',
    profit: '$1000',
    process: [
      { icon: Phone, label: 'Customer Calls' },
      { icon: Headphones, label: 'Agent Responds' },
      { icon: Hash, label: 'TFN Setup' },
      { icon: CheckCircle, label: 'Follow-up' }
    ]
  },
  { 
    ...
    description: 'Full-spectrum digital marketing solutions',
    profit: '$1000',
    process: [
      { icon: Phone, label: 'Customer Calls' },
      { icon: Headphones, label: 'Agent Responds' },
      { icon: TrendingUp, label: 'Campaign Setup' },
      { icon: CheckCircle, label: 'Follow-up' }
    ]
  },
  { 
    icon: Search, 
    title: 'SEO Services (Online & Offline)', 
    description: 'Comprehensive SEO optimization for maximum visibility',
    profit: '$1000',
    process: [
      { icon: Phone, label: 'Customer Calls' },
      { icon: Headphones, label: 'Agent Responds' },
      ...
      <section id="services" className="py-20 px-4 bg-muted/50">
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-sm text-muted-foreground mt-2">Click or hover to see process flow and profit potential</p>
          </motion.div>
          ...
          >
            {services.map((service, index) => (
              <motion.div key={index} variants={fadeInUp}>
                <Card 
                  className="h-full hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border-border/50 cursor-pointer relative overflow-hidden"
                ...
                >
                  ...
                  <CardContent>
                    ...
                    {/* Process Flow - Shows on hover (desktop) or click (mobile) */}
                    <AnimatePresence>
                      {activeService === index && (
                        <motion.div
                          initial={{ opacity: 0, height: 0 }}
                        ...
                        >
                          <h4 className="text-sm font-semibold mb-3 text-primary">Process Flow:</h4>
